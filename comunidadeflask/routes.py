...
from comunidadeflask import app, database, bcrypt
from comunidadeflask.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
from comunidadeflask.models import Usuario, Post
